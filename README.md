...
2. Install irtt: `go get -u github.com/samiemostafavi/irtt/cmd/irtt`
...
2. Install the `stringer` utility by doing
   `go get -u golang.org/x/tools/cmd/stringer` and `go install golang.org/x/tools/cmd/stringer`.
...
then from the `github.com/samiemostafavi/irtt` directory, do:
