...
func NewClientConfig() *ClientConfig {
	return &ClientConfig{
		...
		FrameSourcePath: DefaultFrameSourcePath,
...
func (c *ClientConfig) MarshalJSON() ([]byte, error) {
	...
	j := &struct {
		...
		FrameSourcePath string        `json:"frame_source_path"`
		FrameDurationMS float32       `json:"frame_duration_ms"`
		...
		FrameSourcePath: c.FrameSourcePath,
